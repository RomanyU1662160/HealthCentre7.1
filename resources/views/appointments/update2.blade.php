...
<div class="container ">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card ">
                <div class="card-header bg-romany-fade text-center text-white"> <h5> Edit Appointment </h5>  {{$patient->fullName()}}   </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('patient.newAppointment',$patient)}}" class="{{($errors->count())? ' was-validated' : ' '}} ">
                        ...
                        <div class="form-group row">
                          <label for="Appointment-doctor" class="col-md-4 col-form-label text-md-right"> Appointment Doctor</label>
                            <div class="col-md-6">
                                <input id="appointment-doctor" type="text" class="form-control{{ $errors->has('Appointment-doctor') ? ' is-invalid' : '' }}" name="appointment-doctor" value="{{ $patient->doctor->id }}" }} readonly>
                           </div>
                        </div>
